 ...
 * Generated at: 2018-08-29 22:07:39 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.hosts.html;
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  if (!ipExists) {
    host_success = "[Address Resolver] Could not determine host from service and utils.";
      ...
      out.write("    <title>Second Screen HTML Controller Example with the Red5 Pro Server!</title>\n");
      out.write("    <link rel=\"stylesheet\" type=\"text/css\" href=\"style/main.css\">\n");
      out.write("    <script src=\"lib/host/secondscreen-host.min.js\"></script>\n");
      out.write("  </head>\n");
      out.write("  <body>\n");
 ...
 if (ipExists) { 
      ...
      out.write("            </p>\n");
      out.write("          </div>\n");
      out.write("          <h2 class=\"tag-line\">SECOND SCREEN HTML CONTROLLER</h2>\n");
      out.write("        </div>\n");
      out.write("        <div>\n");
      out.write("          <div>\n");
      out.write("            <p>Once the color chip below is no longer black, this page has become a <span class=\"red-text\">Second Screen Host</span>!</p>\n");
      out.write("            <p>To connect and communicate with this page, open a native application integrated with the <a class=\"link\" href=\"http://red5pro.com/docs/streaming/overview/\" target=\"_blank\">Second Screen SDKs</a> on your favorite device to turn it into a <span class=\"red-text\">Second Screen Client</span>!</p>\n");
      out.write("          </div>\n");
      out.write("          <div id=\"secondscreen-example-container\">\n");
      out.write("            <div id=\"version-field\">Red5 Pro Second Screen Not loaded.</div>\n");
      out.write("            <div id=\"slot\"></div>\n");
      out.write("            <p id=\"sendForm\">\n");
      out.write("              <input type=\"text\" id=\"sendInput\" value=\"Hello, World!\"></input>\n");
      out.write("              <button id=\"sendButton\" onclick=\"window.notifyClient('Host Message', window.document.getElementById('sendInput').value);\">Send Message!</button>\n");
      out.write("            </p>\n");
      out.write("          </div>\n");
      out.write("          <script>\n");
      out.write("            (function(window, document) {\n");
      ...
      out.write("              var checkForHost = function() {\n");
      out.write("                clearTimeout(checkId);\n");
      out.write("                if(typeof window.secondscreenHost !== 'undefined') {\n");
      out.write("                  host = window.secondscreenHost.noConflict();\n");
      out.write("                  document.getElementById('version-field').innerText = host.versionStr();\n");
      out.write("                }\n");
      out.write("                else {\n");
      out.write("                  checkId = setTimeout(checkForHost, 100);\n");
      out.write("                }\n");
      out.write("              }\n");
      out.write("              checkForHost();\n");
      out.write("             }(this, document));\n");
      out.write("          </script>\n");
      out.write("          <div style=\"width: 100%; text-align: right;\">\n");
      out.write("            <p><a class=\"red-text link\" href=\"../downloads/html.zip\">Download</a> this example.</p>\n");
      out.write("          </div>\n");
      out.write("          <div>\n");
      out.write("            <p>This example demonstrates how the <span class=\"red-text\">Second Screen Host</span> can pass controller displays written using the webstack of HTML/CSS/JS to the <span class=\"red-text\">Second Screen Client</span> running on a mobile device! In fact, you can visit the actual HTML page being delivered <a class=\"red-text link\" href=\"scheme/basic-scheme.html\" target=\"_blank\">here</a>.</p>\n");
      out.write("            <p class=\"medium-font-size\">Connect more devices and have some fun!</p>\n");
      out.write("          </div>\n");
      out.write("        </div>\n");
      out.write("        <hr class=\"top-padded-rule\" />\n");
      out.write("        <h3><a class=\"link\" href=\"http://red5pro.com/docs/streaming/overview/\" target=\"_blank\">Second Screen SDKs</a></h3>\n");
      out.write("        <p>You can download the Red5 Pro Second Screen SDKs from your <a class=\"link\" href=\"http://account.red5pro.com/download\" target=\"_blank\">Red5 Pro Accounts</a> page.</p>\n");
      out.write("        <p>Please visit the online <a class=\"link\" href=\"http://red5pro.com/docs/secondscreen/overview/\" target=\"_blank\">Red5 Pro Documentation</a> for further information about integrating the Second Screen SDKs into your own native application!</p>\n");
      out.write("        <hr class=\"top-padded-rule\" />\n");
      out.write("        <div>\n");
      ...
      out.write("              var secondscreenHost = window.secondscreenHost.noConflict();\n");
      out.write("              var config = {\n");
      out.write("                name: 'HTML Control Basic',\n");
      out.write("                maxPlayers: 10,\n");
      out.write("                registryAddress: '");
      out.print( ip );
      out.write("',\n");
      out.write("                swfobjectUrl: 'lib/host/swf/swfobject.js',\n");
      out.write("                swfUrl: \"lib/host/swf/secondscreenHost.swf\",\n");
      out.write("                minimumVersion: {\n");
      out.write("                  major: 0,\n");
      out.write("                  minor: 0\n");
      out.write("                },\n");
      out.write("                controlsUrl: 'scheme/basic-scheme.html?' + timestamp,\n");
      out.write("                controlMode: secondscreenHost.ControlModes.HTML,\n");
      out.write("                error: function(error) {\n");
      out.write("                  secondscreenHost.log.error('Registry connection error: ' + error);\n");
      out.write("                },\n");
      out.write("                success: function() {\n");
      out.write("                  secondscreenHost.log.info('Registry connected.');\n");
      out.write("                }\n");
      out.write("              };\n");
      out.write("              secondscreenHost.setLogLevel(secondscreenHost.LogLevels.INFO);\n");
      out.write("              secondscreenHost.start(config);\n");
      out.write("\n");
      out.write("              secondscreenHost.on(secondscreenHost.EventTypes.SHOW_SLOT_COLOR, function(e) {\n");
      out.write("                var slot = document.getElementById('slot');\n");
      out.write("                slot.style.background = e.color;\n");
      out.write("              });\n");
      out.write("\n");
      out.write("              secondscreenHost.on(secondscreenHost.EventTypes.DEVICE_CONNECTED, function (e) {\n");
      out.write("                window.notifyClient('Host Welcome', 'Welcome!');\n");
      out.write("                print(\"<p class=\\\"red-text medium-font-size\\\">Device Connected (id, name):<br>&nbsp;&nbsp;\" + e.device.id + ', ' + e.device.name + \"</p>\");\n");
      out.write("              });\n");
      out.write("\n");
      out.write("              secondscreenHost.on(secondscreenHost.EventTypes.DEVICE_DISCONNECTED, function (e) {\n");
      out.write("                print(\"<p class=\\\"red-text medium-font-size\\\">Device Disconnected (id, name):<br>&nbsp;&nbsp;\" + e.device.id + ', ' + e.device.name + \"</p>\");\n");
      out.write("              });\n");
      out.write("\n");
      out.write("              secondscreenHost.on(secondscreenHost.EventTypes.CONTROLS_URL_CHANGE, function(e) {\n");
      out.write("                print('Controls url will change: ' + e.url);\n");
      out.write("              });\n");
      out.write("\n");
      out.write("              secondscreenHost.on(secondscreenHost.EventTypes.MESSAGE, function(e) {\n");
      out.write("                var deviceId = e.device.id,\n");
      out.write("                    message = e.message,\n");
      out.write("                    state = e.state;\n");
      out.write("\n");
      out.write("                if(message === 'ready') {\n");
      out.write("                  e.device.send(\"test\");\n");
      out.write("                  e.device.send(\"testing\", 1, 2, 3);\n");
      out.write("                  e.device.send(\"testing\", 1.126, \"52 skidoo\", [1, 2, 3]);\n");
      out.write("                }\n");
      out.write("\n");
      out.write("                if(state !== undefined) {\n");
      out.write("                  var log = 'Event.Message: ' +\n");
      out.write("                            '(' + message + ') ' +\n");
      out.write("                            '<br>&nbsp;&nbsp;From: ' + deviceId +\n");
      out.write("                            '<br>&nbsp;&nbsp;Message: ' + JSON.stringify(state,null,2);\n");
      out.write("                  print(log);\n");
      out.write("                }\n");
      out.write("\n");
      out.write("              });\n");
      out.write("\n");
      out.write("              function print(message) {\n");
      out.write("                var p = document.createElement('p');\n");
      out.write("                p.innerHTML = message;\n");
      out.write("                document.getElementById('secondscreen-example-container').appendChild(p);\n");
      out.write("               secondscreenHost.log.info(message);\n");
      out.write("              }\n");
      out.write("\n");
      out.write("              window.notifyClient = function(type, message) {\n");
      out.write("                secondscreenHost.allDevices().send('state', {\n");
      out.write("                  state: type,\n");
      out.write("                  message: message\n");
      out.write("                });\n");
      out.write("              };\n");
      out.write("\n");
      out.write("              function handleSecondScreenHostIpChange(value) {\n");
      out.write("                var slot = document.getElementById('slot');\n");
      out.write("                secondscreenHost.stop();\n");
      out.write("                slot.style.backgroundColor = \"#000\";\n");
      out.write("                config.registryAddress = value;\n");
      out.write("                secondscreenHost.start(config);\n");
      out.write("              }\n");
      out.write("              window.r5pro_registerIpChangeListener(handleSecondScreenHostIpChange);\n");
      out.write("\n");
      out.write("      }(window));\n");
      out.write("    </script>\n");
