 ...
 * Generated at: 2018-08-29 22:09:27 UTC
...
import com.infrared5.red5pro.examples.service.LiveStreamListService;
import java.util.Map.Entry;
import java.util.Map;
import java.util.Iterator;

public final class playback_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.infrared5.red5pro.examples.service.LiveStreamListService");
  ...
  String baseUrl = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort();
      ...
      out.write("    <title>Video On Demand Playback with the Red5 Pro Server!</title>\n");
      ...
      out.write("      }\n");
      out.write("\n");
      out.write("      .stream-menu-listing {\n");
      out.write("        list-style: none;\n");
      out.write("        padding: 0;\n");
      out.write("        margin: 0;\n");
      out.write("      }\n");
      out.write("\n");
      out.write("      .no-streams-entry {\n");
      out.write("        padding-left: 20px;\n");
      out.write("      }\n");
      out.write("\n");
      out.write("      .streaming-menu-content {\n");
      out.write("        margin-top: 30px;\n");
      out.write("        margin-bottom: 30px;\n");
      out.write("      }\n");
      out.write("\n");
      out.write("      .stream-listing {\n");
      out.write("        padding: 0 20px 20px 20px;\n");
      out.write("        border-bottom: 1px solid #e3e3e3;\n");
      out.write("      }\n");
      out.write("\n");
      out.write("      .stream-header {\n");
      out.write("        margin: 10px 0;\n");
      out.write("      }\n");
      out.write("\n");
      out.write("      .stream-container {\n");
      ...
      out.write("      }\n");
      out.write("\n");
      out.write("      #video-holder, #red5pro-subscriber {\n");
      out.write("        width: 100%;\n");
      out.write("      }\n");
      out.write("\n");
      ...
      out.write("      }\n");
      out.write("\n");
      out.write("      template { display: none }\n");
      out.write("    </style>\n");
      ...
      out.write("    <link href=\"lib/red5pro/red5pro-media.css\" rel=\"stylesheet\"></script>\n");
      out.write("    <script>\n");
      out.write("      // Shim so we can style in IE6/7/8\n");
      out.write("      document.createElement('template');\n");
      out.write("    </script>\n");
      out.write("  </head>\n");
      out.write("  <body>\n");
      out.write("    <template id=\"video-playback\">\n");
      ...
      out.write("      <div id=\"video-container\">\n");
      out.write("            <div id=\"video-holder\" style=\"height:405px;\">\n");
 ...
 if (ipExists) { 
      ...
      out.write("            </p>\n");
      out.write("          </div>\n");
      out.write("          <h2 class=\"tag-line\">VIDEO ON DEMAND PLAYBACK FOR ANY SCREEN</h2>\n");
      out.write("        </div>\n");
      ...
      out.write("          <div>\n");
      out.write("            <p>Below you will find the list of recorded video to stream.</p>\n");
      out.write("            <p>If a stream is available to playback, you can select to view in browser on this page or a seperate window using the <strong>Red5 Pro HTML SDK</strong>.</p>\n");
      out.write("            <div id=\"available-streams-listing\" class=\"menu-content streaming-menu-content\">\n");
      out.write("              <h3 class=\"no-streams-entry\">Requesting files...</h3>\n");
      out.write("            </div>\n");
      out.write("            <p>You can Record a Broadcast session by visiting the <a class=\"broadcast-link link\" href=\"broadcast.jsp?host=");
      out.print(ip);
      out.write("\" target=\"_blank\">Broadcast page</a> and checking the <b>Enable Recording</b> button.</p>\n");
      out.write("            <p><em>Once a Broadcast session is started and stopped, the Video On Demand</em> (VOD) <em>Recording will be available. Return to this page to see the stream name listed.</em></p>\n");
      out.write("          </div>\n");
      out.write("          <hr class=\"top-padded-rule\" />\n");
      out.write("          <h3><a class=\"link\" href=\"https://www.red5pro.com/docs/streaming/\" target=\"_blank\">Streaming SDKs</a></h3>\n");
      ...
      out.write("          <p>Please visit the online <a class=\"link\" href=\"https://www.red5pro.com/docs/streaming/\" target=\"_blank\">Red5 Pro Documentation</a> for further information about integrating the streaming SDKs into your own native application!</p>\n");
      out.write("          <hr class=\"top-padded-rule\" />\n");
      out.write("          <div>\n");
      ...
      out.write("    <script>\n");
      out.write("      // Put server vars globally.\n");
      ...
      out.write("');\n");
      out.write("   </script>\n");
      out.write("    <script src=\"script/r5pro-playback-failover.js\"></script>\n");
      out.write("    <script>\n");
      out.write("      // Filtering HLS playback using servlet.\n");
      out.write("      (function (window, document, $) {\n");
      out.write("       'use strict';\n");
      out.write("\n");
      out.write("       var protocol = \"");
      out.print(protocol);
      out.write("\";\n");
      out.write("       var ip = \"");
      out.print(ip);
      out.write("\";\n");
      out.write("       var port = window.location.port ? window.location.port : (protocol === 'https' ? 443 : 80);\n");
      out.write("\n");
      out.write("       var httpRegex = /^http/i;\n");
      out.write("       var baseUrl = protocol + '://' + ip + ':' + port + '/live';\n");
      out.write("       var mediafilesServletURL = [baseUrl, 'mediafiles'].join('/');\n");
      out.write("       var playlistServletURL = [baseUrl, 'playlists'].join('/');\n");
      out.write("       var store = {}; // name: {name:string, url:string, formats:[hls|flv]}\n");
      out.write("\n");
      out.write("       var parseItem = function (item) {\n");
      out.write("          var itemName = item.name; // item.name.substring(0, item.name.lastIndexOf('.'));\n");
      out.write("          var itemUrl = httpRegex.test(item.url) ? item.url : [baseUrl, item.url].join('/');\n");
      out.write("          return {\n");
      out.write("            name: itemName,\n");
      out.write("            url: itemUrl\n");
      out.write("          };\n");
      out.write("       }\n");
      out.write("\n");
      out.write("       var getItemList = function (data, url, listProperty, formatType, cb) {\n");
      out.write("         var req = new XMLHttpRequest();\n");
      out.write("         req.onreadystatechange = function () {\n");
      out.write("           if (this.readyState === 4) {\n");
      out.write("             if (this.status >= 200 && this.status < 400) {\n");
      out.write("                var response = JSON.parse(this.response);\n");
      out.write("                console.log(\"Response: \" + JSON.stringify(response, null, 2));\n");
      out.write("                var list = response.hasOwnProperty(listProperty) ? response[listProperty] : [];\n");
      out.write("                var items = [];\n");
      out.write("                var i, item, length = list.length;\n");
      out.write("                for (i = 0; i < length; i++) {\n");
      out.write("                  item = parseItem(list[i]);\n");
      out.write("                  if (!data.hasOwnProperty(item.name)) {\n");
      out.write("                    data[item.name] = {\n");
      out.write("                      name: item.name,\n");
      out.write("                      urls: {}\n");
      out.write("                    };\n");
      out.write("                  }\n");
      out.write("                  data[item.name].urls[formatType] = item.url;\n");
      out.write("                }\n");
      out.write("                cb(data);\n");
      out.write("            }\n");
      out.write("            else if (this.status === 0 || this.status > 400) {\n");
      out.write("              cb(data);\n");
      out.write("            }\n");
      out.write("          }\n");
      out.write("        }\n");
      out.write("        req.onerror = function () {\n");
      out.write("          cb(data);\n");
      out.write("        }\n");
      out.write("        req.timeout = 60000 * 5; // 5 minutes\n");
      out.write("        req.open('GET', url, true);\n");
      out.write("        req.send();\n");
      out.write("      };\n");
      out.write("\n");
      out.write("      var getMediafiles = function (data, cb) {\n");
      out.write("        getItemList(data, mediafilesServletURL, 'mediafiles', 'rtmp', cb);\n");
      out.write("      }\n");
      out.write("\n");
      out.write("      var getPlaylists = function (data, cb) {\n");
      out.write("        var doInclude = \"");
      out.print(playlistFlag);
      out.write("\" == \"1\";\n");
      out.write("        if (doInclude) {\n");
      out.write("          getItemList(data, playlistServletURL, 'playlists', 'hls', cb);\n");
      out.write("        }\n");
      out.write("        else {\n");
      out.write("          cb(data);\n");
      out.write("        }\n");
      out.write("      };\n");
      out.write("\n");
      out.write("      var populateListing = function (data) {\n");
      out.write("        console.log(\"Store:\\r\\n\" + JSON.stringify(data, null, 2));\n");
      out.write("\n");
      out.write("        var $container = $('#available-streams-listing');\n");
      out.write("        var innerContent = '';\n");
      out.write("        var getStreamListItem = function (item) {\n");
      out.write("          var json = encodeURIComponent(JSON.stringify(item));\n");
      out.write("          var streamName = item.name;\n");
      out.write("          var urls = item.urls;\n");
      out.write("          var html = \"<li data-stream=\\\"\" + streamName + \"\\\" data-streamitem=\\\"\" + json + \"\\\" class=\\\"stream-listing\\\">\\r\\n\" +\n");
      out.write("                  \"<h2 class=\\\"stream-header\\\">\" + streamName + \"</h2>\\r\\n\" +\n");
      out.write("                  \"<p>\\r\\n\" +\n");
      out.write("                    \"<a class=\\\"medium-font-size subscriber-link link red-text\\\" style=\\\"cursor: pointer;\\\" onclick=\\\"invokeViewStream('\" + streamName + \"'); return false;\\\">\\r\\n\" +\n");
      out.write("                      \"View <strong>\" + streamName + \"</strong>'s stream on this page.\" +\n");
      out.write("                    \"</a>\\r\\n\" +\n");
      out.write("                  \"</p>\\r\\n\" +\n");
      out.write("                  \"<hr>\\r\\n\" +\n");
      out.write("                  \"<p>\\r\\n\" +\n");
      out.write("                    \"<span class=\\\"black-text\\\">or,&nbsp;&nbsp;<a class=\\\"subscriber-link link red-text\\\" style=\\\"cursor: pointer;\\\" onclick=\\\"invokeViewPageStream('\" + streamName + \"'); return false;\\\">Open in another window</a></span>\\r\\n\" +\n");
      out.write("                  \"</p>\\r\\n\" +\n");
      out.write("                \"</li>\";\n");
      ...
      out.write("          innerContent += getStreamListItem(data[key]);\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        if (innerContent.length > 0) {\n");
      out.write("          innerContent = '<ul class=\"stream-menu-listing\">' + innerContent + '</ul>';\n");
      out.write("          $container.html(innerContent);\n");
      out.write("        }\n");
      out.write("        else {\n");
      out.write("          $container.html('<h3 class=\"no-streams-entry\">No recordings found</h3>');\n");
      out.write("        }\n");
      out.write("      };\n");
      out.write("\n");
      out.write("      getMediafiles(store, function(data) {\n");
      out.write("        getPlaylists(data, function(data) {\n");
      out.write("          populateListing(data);\n");
      out.write("        });\n");
      out.write("       });\n");
      out.write("\n");
      out.write("      })(this, document, jQuery.noConflict());\n");
      out.write("    </script>\n");
      out.write("  </body>\n");
      out.write("</html>\n");
      out.write("\n");
