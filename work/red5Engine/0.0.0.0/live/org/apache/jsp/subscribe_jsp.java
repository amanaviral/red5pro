 ...
 * Generated at: 2018-08-29 22:20:33 UTC
...
public final class subscribe_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  if(names.size() == 0) {
    ...
    ret.append("<p>To begin your own Broadcast session, visit the <a class=\"broadcast-link link\" href=\"broadcast.jsp?host=" + ip + "\">Broadcast page</a>!</p>\r\n");
      ...
      out.write("    <title>Stream Subscription with the Red5 Pro Server!</title>\n");
      out.write("    <style>\n");
 ...
 if (ipExists) { 
      ...
      out.write("            </p>\n");
      out.write("          </div>\n");
      out.write("          <h2 class=\"tag-line\">LIVE SUBSCRIBING FOR ANY SCREEN</h2>\n");
      out.write("        </div>\n");
      ...
      out.write("          <div>\n");
      out.write("            <p>Below you will find the list of current live streams to subscribe to.</p>\n");
      out.write("            <p>If a stream is available to subscribe to, you can select to view in browser on this page or a seperate window using the <strong>Red5 Pro HTML SDK</strong> or you can view by opening the <strong>RTSP</strong> link.</p>\n");
      out.write("            ");
      ...
      out.write("\");\n");
      out.write("    </script>\n");
      out.write("    <script src=\"script/r5pro-subscriber-failover.js\"></script>\n");
      out.write("  </body>\n");
      out.write("</html>");
